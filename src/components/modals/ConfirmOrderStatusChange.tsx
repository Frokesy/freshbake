  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        exit="exit"
      >
        <h2 className="text-center font-semibold">Update Order Status?</h2>
        <h2 className="text-[13px] px-3 text-center">
          Are you sure you want to update the order status for this item??
        </h2>
...
export default ConfirmOrderStatusChange;
